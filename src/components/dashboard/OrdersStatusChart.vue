...
const chartOptions = computed<ApexOptions>(() => ({
  ...
  plotOptions: { pie: { donut: { size: '68%', labels: { show: true, total: { show: true, label: 'Total', formatter: () => '100%' } } } } },
  stroke: { width: 0 },
...
<template>
  <v-card variant="flat" border class="pa-5 h-100">
    ...
    <div class="text-caption text-medium-emphasis mb-3">Distribuição atual da carteira</div>
    <apexchart type="donut" height="310" :options="chartOptions" :series="series" />
  </v-card>
</template>
